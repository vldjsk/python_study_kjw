### shapes.py 모듈을 사용 ###
# 1. 변의 길이가 10 인 정사각형의 넓이를 계산하여 출력
#반지름이 5 인 원의 넓이를 계산하고 출력
...
# 2. from import 사용 shape 모듈에서 calculate_square_area 함수만을
# import해서 변의 길이가 7인정사각혀의 넓이를
# 계산하고 출력
